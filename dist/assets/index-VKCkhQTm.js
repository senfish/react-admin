import{r,as as d,at as j,j as e}from"./index-BaYBV5Jy.js";import{C as U}from"./index-BVywSslO.js";const A="/platform.jpg";function N(t){return/^\d+$/.test(t)?"".concat(t,"px"):t}function x(){}var u=function(){return u=Object.assign||function(t){for(var a,s=1,n=arguments.length;s<n;s++){a=arguments[s];for(var o in a)Object.prototype.hasOwnProperty.call(a,o)&&(t[o]=a[o])}return t},u.apply(this,arguments)},I=function(t,a){var s={};for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&a.indexOf(n)<0&&(s[n]=t[n]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,n=Object.getOwnPropertySymbols(t);o<n.length;o++)a.indexOf(n[o])<0&&Object.prototype.propertyIsEnumerable.call(t,n[o])&&(s[n[o]]=t[n[o]]);return s};function c(t){var a=t.width,s=t.height,n=t.value,o=t.defaultValue,m=t.language,v=t.theme,g=t.options,k=t.overrideServices,S=t.editorWillMount,_=t.editorDidMount,P=t.editorWillUnmount,w=t.onChange,p=t.className,b=t.uri,y=r.useRef(null),i=r.useRef(null),M=r.useRef(null),C=r.useRef(null),D=N(a),B=N(s),E=r.useRef(w);E.current=w;var V=r.useMemo(function(){return{width:D,height:B}},[D,B]),R=function(){var l=S(j);return l||{}},T=function(){_(i.current,j),M.current=i.current.onDidChangeModelContent(function(l){var f;C.current||(f=E.current)===null||f===void 0||f.call(E,i.current.getValue(),l)})},W=function(){P(i.current,j)},F=function(){var l=n!==null?n:o;if(y.current){var f=u(u({},g),R()),O=b==null?void 0:b(j),h=O&&d.getModel(O);h?(h.setValue(l),d.setModelLanguage(h,m)):h=d.createModel(l,m,O),i.current=d.create(y.current,u(u(u({model:h},p?{extraEditorClassName:p}:{}),f),v?{theme:v}:{}),k),T()}};return r.useEffect(F,[]),r.useEffect(function(){if(i.current){if(n===i.current.getValue())return;var l=i.current.getModel();C.current=!0,i.current.pushUndoStop(),l.pushEditOperations([],[{range:l.getFullModelRange(),text:n}],void 0),i.current.pushUndoStop(),C.current=!1}},[n]),r.useEffect(function(){if(i.current){var l=i.current.getModel();d.setModelLanguage(l,m)}},[m]),r.useEffect(function(){if(i.current){g.model;var l=I(g,["model"]);i.current.updateOptions(u(u({},p?{extraEditorClassName:p}:{}),l))}},[p,g]),r.useEffect(function(){i.current&&i.current.layout()},[a,s]),r.useEffect(function(){d.setTheme(v)},[v]),r.useEffect(function(){return function(){i.current&&(W(),i.current.dispose()),M.current&&M.current.dispose()}},[]),r.createElement("div",{ref:y,style:V,className:"react-monaco-editor-container"})}c.defaultProps={width:"100%",height:"100%",value:null,defaultValue:"",language:"javascript",theme:null,options:{},overrideServices:{},editorWillMount:x,editorDidMount:x,editorWillUnmount:x,onChange:x,className:null};c.displayName="MonacoEditor";const L=`
